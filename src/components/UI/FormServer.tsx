    ...
    <div className="bg-gray-800/80 border border-gray-700 rounded-xl px-6 mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Input
          ...
          error={errors.name}
          className={
            formFocusIndex === 0 && !isInputActive ? 'border-red-500 ring-2 ring-red-500' : ''
          }
        />
        <Input
          ref={el => {
          ...
          error={errors.url}
          className={
            formFocusIndex === 1 && !isInputActive ? 'border-red-500 ring-2 ring-red-500' : ''
          }
        />
        <Input
          ref={el => {
          ...
          className={
            formFocusIndex === 2 && !isInputActive ? 'border-red-500 ring-2 ring-red-500' : ''
          }
        />
        <Input
          ref={el => {
          ...
          className={
            formFocusIndex === 3 && !isInputActive ? 'border-red-500 ring-2 ring-red-500' : ''
          }
        />
      </div>
