...
export default function PlayButton({ isFocused, disabled, streamId, nextEpisode,  onClick }: Props) {
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className={`
        flex items-center gap-2.5 px-6 py-3 rounded-xl font-semibold text-2xl max-md:text-sm
